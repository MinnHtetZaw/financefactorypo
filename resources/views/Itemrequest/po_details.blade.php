...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="font-weight-normal">Factory PR Details Page</h3>
    </div>
</div>



<div class="row printableArea mt-3">
    <div class="col-md-12">
            	...
            	<div class="row align-items-center justify-content-center">
            		<div class="col-5">
            			<div class="row mt-5">
			              	...
			              	<h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->po_number}}</h5>
				        </div>

            			<div class="row mt-1">
			              	<div class="font-weight-bold text-primary col-md-4">PR @lang('lang.date')</div>
			              	<h5 class="font-weight-normal col-md-4" style="font-size:18px">{{date('d-m-Y', strtotime($PO->po_date))}}</h5>
				        </div>

				        <div class="row mt-1">
			              	<div class="font-weight-bold text-primary col-md-4">Required @lang('lang.date')</div>
			              	<h5 class="font-weight-normal col-md-4" style="font-size:18px">{{date('d-m-Y', strtotime($PO->receive_date))}}</h5>
				        </div>

                        @if($PO->po_type == 9)
				        <div class="row mt-1">
			              	<div class="font-weight-bold text-primary col-md-4">Requested By</div>
			              	<h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->requested_by}}</h5>
				        </div>
				        @endif
                    ...
                    <div class="col-5">
                        ...
                        <div class="row mt-1">
                            ...
                            <h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->total_rolls}}</h5>
                        </div>

                        <div class="row mt-1">
                            <div class="font-weight-bold text-primary col-md-4">@lang('lang.total') Yards</div>
                            <h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->total_yards}}</h5>
                        </div>
                        @elseif($PO->po_type == 10)
                            <div class="row mt-1">
                            <div class="font-weight-bold text-primary col-md-4">@lang('lang.total') Quantity</div>
                            <h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->total_quantity}}</h5>
                        </div>
                        @endif

                        <div class="row mt-1">
                            <div class="font-weight-bold text-primary col-md-4">Total Cost</div>
                            <h5 class="font-weight-normal col-md-4" style="font-size:18px">{{$PO->total_price}}</h5>
                        </div>

                        <div class="row mt-1">
                            <div class="font-weight-bold text-primary col-md-4">Status</div>
                            @if($PO->status == 0)
                                <h5 class="font-weight-normal col-md-4" style="font-size:18px">Pending</h5>
                            @elseif($PO->status == 1)
                                <h5 class="font-weight-normal col-md-4" style="font-size:18px">Approved</h5>
                            @elseif($PO->status == 2)
                                <h5 class="font-weight-normal col-md-4" style="font-size:18px">Purchased</h5>
                            @elseif($PO->status == 3)
                                <h5 class="font-weight-normal col-md-4" style="font-size:18px">Arrived</h5>
                            @endif
